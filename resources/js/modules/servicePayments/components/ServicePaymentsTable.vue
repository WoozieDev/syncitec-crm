...
import { edit, show } from '@/routes/service-payments';
...
const emit = defineEmits<{
    (e: 'delete', payment: ServicePayment): void;
}>();
...
<template>
    ...
    >
        <div
            class="hidden px-6 pb-3 lg:grid lg:grid-cols-[minmax(0,1.5fr)_minmax(0,1.1fr)_minmax(0,1fr)_minmax(0,0.75fr)_minmax(0,0.8fr)_minmax(0,0.95fr)_minmax(0,1.25fr)_auto]"
        >
        ...
        <div class="space-y-4">
            ...
            >
                <div
                    class="grid grid-cols-1 gap-4 p-4 md:p-5 lg:grid-cols-[minmax(0,1.5fr)_minmax(0,1.1fr)_minmax(0,1fr)_minmax(0,0.75fr)_minmax(0,0.8fr)_minmax(0,0.95fr)_minmax(0,1.25fr)_auto] lg:items-center lg:gap-3"
                >
                    <div>
                        ...
                        <p class="text-sm font-bold text-foreground">
                            {{ payment.service?.name ?? 'Servicio no disponible' }}
                        </p>
                        <p class="text-[11px] text-muted-foreground">
                            {{
                                payment.service?.service_type.name ??
            ...
            >
                <p class="text-center text-sm text-muted-foreground">
                    No se encontraron pagos de servicios con los filtros actuales.
                </p>
            </Card>
        </div>
